...
public abstract class LibraryObject implements Serializable {
    ...
    public void setArtLoading() {
        this.artLoad = true;
    }

    public boolean getArtLoading() {
        return !this.artLoad;
    }

    public Bitmap getArtMiniature() {
        return miniatureArt;
    }
    ...
    public Uri getArtUri() {
        return artPath == null ? null : Uri.parse(artPath);
    }
